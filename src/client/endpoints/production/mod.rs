...
impl<'a> Endpoint<'a>
{
    ...
    {
        workorder::Endpoint { client: self.client }
    }
    ...
    {
        workorder_pos::Endpoint { client: self.client }
    }
    ...
    {
        workorder_bom::Endpoint { client: self.client }
    }
    ...
    {
        backflush::Endpoint { client: self.client }
    }
}
