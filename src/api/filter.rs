...
impl LogicalOperatorSelector
{
    ...
    pub fn and(mut self) -> OperatorSelector
    {
        ...
        OperatorSelector{ builder: self.builder }
    }
...
impl ToValue for f64  { fn convert(&self) -> String { self.to_string() } }
impl ToValue for f32  { fn convert(&self) -> String { self.to_string() } }

impl ToValue for i64  { fn convert(&self) -> String { self.to_string() } }
impl ToValue for i32  { fn convert(&self) -> String { self.to_string() } }
impl ToValue for i16  { fn convert(&self) -> String { self.to_string() } }
impl ToValue for i8   { fn convert(&self) -> String { self.to_string() } }

impl ToValue for u64  { fn convert(&self) -> String { self.to_string() } }
impl ToValue for u32  { fn convert(&self) -> String { self.to_string() } }
impl ToValue for u16  { fn convert(&self) -> String { self.to_string() } }
impl ToValue for u8   { fn convert(&self) -> String { self.to_string() } }

impl ToValue for bool { fn convert(&self) -> String { self.to_string() } }